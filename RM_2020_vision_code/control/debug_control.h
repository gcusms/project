...
#define CAMERA_PARAM_FILE "/home/sms/RM_2020_vision_code/camera/param/cameraParams.xml"
...
#ifndef Infantry_sentry
/**
 * @brief : 使用步兵的参数函数哨兵的参数
 * @param  1->使用步兵的参数
 * @param 0 -> 使用哨兵的参数
 * @note -----protect the param is true-----
 * 步兵  x:0 y:45.5   z:68.9 
 * 哨兵  x:0 y:45   z:90---待精确设置
*/
#define Infantry_sentry 0
#endif

#if Infantry_sentry == 0
#define PTZ_CAMERA_X 0.f
#define PTZ_CAMERA_Y 45.2
#define PTZ_CAMERA_Z 90
#endif

#if Infantry_sentry == 1
#define PTZ_CAMERA_X 0.f
